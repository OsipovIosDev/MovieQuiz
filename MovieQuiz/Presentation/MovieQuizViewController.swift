...
// структуры
    ...
    private struct QuizQuestion {
        ...
        let text: String                // текст вопроса викторины
        let correctAnswer: Bool         // правильный ответ (да/нет)
    }
    
    private struct QuizResultsViewModel {
        let title: String               // заголовок для результата ответа
        let text: String                // статистика верных ответов
        let buttonText: String          // текст кнопки ответа
    }
    
    private struct QuizStepViewModel {
        let image: UIImage              // загруженное изображение из ассетов
